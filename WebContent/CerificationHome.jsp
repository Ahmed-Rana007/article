						...
						<div class="panel-body">
							<form>
								...
								<div class="form-group row">
									<h3>Certification Dashboard</h3> <br />
									...
									<div class="form-group row container-fluid">
										<div class="col-md-1">
											<div class="bs-example">
												<div class="dropdown">
													<a href="#" class="dropdown-toggle" data-toggle="dropdown">Action <i class="fa fa-arrow-down"></i></a>
													<div class="dropdown-menu">
														<a href="#" class="dropdown-item">1</a><br />
										...
										<div class="col-md-1">
											<div class="bs-example">
												<div class="dropdown">
													<a href="#" class="dropdown-toggle" data-toggle="dropdown">View <i class="fa fa-arrow-down"></i></a>
													<div class="dropdown-menu">
														<a href="#" class="dropdown-item">1</a><br />
														<a href="#" class="dropdown-item">2</a>
													</div>
										...
										<div class="col-md-1"><i class="fa fa-plus"></i> Create</div>
										<div class="col-md-1"><i class="fa fa-remove"></i> Delete</div>
										<div class="col-md-1"><i class="fa fa-pencil"></i> Open</div>
										<div class="col-md-1"><i class="fa fa-Play-circle"></i> Run Now</div>
										<div class="col-md-1"><i class="fa fa-refresh"></i> Refresh</div>
										<div class="col-md-1"><i class="fa fa-filter"> Filter</i></div>
										<div class="col-md-1"><i class="fa fa-object-group"></i> Detach</div>
									</div>
